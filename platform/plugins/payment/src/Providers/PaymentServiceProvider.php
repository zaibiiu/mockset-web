...
use Botble\Payment\Models\PaymentGatewaySetting;
use Botble\Payment\Repositories\Caches\PaymentCacheDecorator;
use Botble\Payment\Repositories\Caches\PaymentGatewaySettingCacheDecorator;
use Botble\Payment\Repositories\Eloquent\PaymentGatewaySettingRepository;
...
class PaymentServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(PaymentGatewaySettingInterface::class, function () {
            return new PaymentGatewaySettingCacheDecorator(new PaymentGatewaySettingRepository(new PaymentGatewaySetting()));
        });
